...
public class AgendaUI {
	...
	private final int OPCAO_EXCLUIR   = 2;
	private final int OPCAO_CONSULTAR = 3;
	private final int OPCAO_LISTAR    = 4;
	...
	public void execute() {
		...
		System.out.println("(default: 'http://localhost:8888/agenda'): ");
		...
		System.out.println("Obrigado por utilizar nossas Aplicações!");
	...
	private int promptMenuPrincipal(Scanner input) {
		...
		do {
			...
			System.out.println();
			System.out.println("-------------------------------------------");
			System.out.println("Agenda de Contatos - RESTFull");
			System.out.println("-------------------------------------------");
			System.out.println("-------------------------------------------");
	...
	private void inserirContato(Scanner input) {
		...
		if (contato != null && contato.getEmail() != null) {
			...
			System.out.println("Digite o endereco (Rua, Numero,CEP, Bairro): ");
